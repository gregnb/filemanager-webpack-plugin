            ...
            var _loop = function _loop(key) {
              ...
              commandOrder.push(function () {
                return new Promise(function (resolve, reject) {
                  ...
                  fs.lstat(command.source, function (err, stats) {
                    ...
                    if (stats.isFile()) {
                      ...
                      cpx.copy(_sourceDir, command.destination, _this2.cpxOptions, function (err) {
                        if (err && _this2.options.verbose) {
                          console.log('  - FileManagerPlugin: Error - copy failed', err);
                        }

                        if (_this2.options.verbose) {
                          console.log('  - FileManagerPlugin: Finished copy source: ' + _sourceDir + ' to destination: ' + command.destination);
                        }
