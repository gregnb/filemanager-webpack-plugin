...
test.serial(
  'should successfully copy and create destination directory { source: "/source", destination: "/dest/doesnt-exist-yet" } provided',
  (t) => {
...
test.serial(
  'should successfully copy and create destination directory when { source: "/source/{file1,file2}.js", destination: "/dest/doesnt-exist-yet" } provided',
  (t) => {
...
test.serial(
  'should successfully copy and create destination directory when { source: "/source/**/*.{html,js}", destination: "/dest/doesnt-exist-yet" } provided',
  (t) => {
...
test.serial(
  'should successfully first create destination if it does not exist and copy inside destination when { source: "/sourceFile.js", destination: "/destFolder" } provided',
  (t) => {
...
test.serial(
  'should unsuccesfully copy a file that does not exist { source: "/filedoesnotexist.js", destination: "/destFolder" } provided',
  (t) => {
...
test.serial(
  'should successfully copy a [hash] file name to destination when { source: "/sourceFile-[hash].js", destination: "/destFolder" } provided',
  (t) => {
...
test.serial(
  'should successfully copy a file to hashed destination when { source: "/sourceFile.js", destination: "[hash]-destFile.js" } provided',
  (t) => {
...
test.serial(
  'should successfully archive (ZIP) a directory to destination ZIP when { source: "/source", destination: "/dest.zip" } provided',
  (t) => {
...
test.serial(
  'should successfully archive (ZIP) a single file to destination ZIP when { source: "/sourceFile.js", destination: "/dest.zip" } provided',
  (t) => {
...
test.serial(
  'should successfully archive (ZIP) a directory glob to destination ZIP when { source: "/source/**/*", destination: "/dest.zip" } provided',
  (t) => {
...
test.serial(
  'should successfully archive (TAR) a directory glob to destination TAR when { source: "/source/**/*", destination: "/dest.zip", format: "tar" } provided',
  (t) => {
...
test.serial(
  'should successfully archive (TAR.GZ) a directory glob to destination TAR.GZ when { source: "/source/**/*", destination: "/dest.tar.gz", format: "tar" } provided',
  (t) => {
...
test.serial(
  'should successfully exclude archive (ZIP) from destination ZIP when { source: "/source", destination: "/source/dest.zip" } provided',
  async (t) => {
...
test.serial(
  'should successfully include root-level files in the archive (ZIP) from destination ZIP when { source: "/source", destination: "/source/dest.zip" } provided',
  async (t) => {
    async function getResult() {
      const data = fs.readFileSync('./testing/test7.zip');
      const zip = await JSZip.loadAsync(data);
